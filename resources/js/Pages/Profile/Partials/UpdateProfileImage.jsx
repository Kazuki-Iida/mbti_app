    ...
    return (
        <>
            <form onSubmit={submit} className="" enctype="multipart/form-data">
                ...
                <button className="mt-5 flex items-center border border-gray-400 p-1 rounded-md"><img src="img/post.png" className="w-[20px] mr-1" /><p className="font-bold">送信</p></button>
            </form>
